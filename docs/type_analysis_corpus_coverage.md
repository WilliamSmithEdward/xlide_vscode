...
| String family | Partial | Fixed-length declaration parser/symbol/hover tests; oracle-backed literal bounds for `String * 1`, `String * 65526`, `String * 0`, and `String * 65527`; fixed-length string-size diagnostic tests; fixed-length string and string-size legacy corpus cases | Fixed-length assignment truncation, nonliteral length expression semantics, scalar member-access receiver controls, type suffix `$` | Spec and oracle mix |
