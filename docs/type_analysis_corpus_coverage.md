...
| Cross-module procedure calls | Partial | Project signature tests for unique exported standard-module `Sub`/`Function` calls | Private visibility, duplicate public names beyond no-diagnostic controls, module qualification, shadowing, class/document procedures | Workbook-level fixture builder plus analyzer tests |
