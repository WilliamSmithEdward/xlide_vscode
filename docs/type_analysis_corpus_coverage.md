...
1. **Workbook fixture files**: initial workbook-analysis assertions now run from
   ...
   token-backed `Implements` placement diagnostics, same-workbook live-source
   overlays, cross-workbook overlay isolation, and
