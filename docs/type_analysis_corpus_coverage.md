...
9. **Document-module event handler matrix**: extend the completed
   ...
   non-red wrong-module guidance, and continued exclusion from object-member
   completion/callable surfaces.
