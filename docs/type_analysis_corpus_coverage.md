...
9. **Class/object member edge matrix**: verify late-bound `Object` and
   `Variant` receivers, remaining object-module declaration restrictions, and
   default members declared through exported
