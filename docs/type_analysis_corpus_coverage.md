...
1. **Workbook fixture files**: initial workbook-analysis assertions now run from
   ...
   declarations, same-workbook live-source overlays, cross-workbook overlay
   isolation, and common unresolved external/reference
