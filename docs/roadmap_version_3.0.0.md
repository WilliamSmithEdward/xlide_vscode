...
Forward backlog moved out of Version 2.2.0 so that 2.2.0 can focus on static
analysis completeness, MS-VBAL completeness, syntax corpus closure, and type
corpus closure.

Version 3.0.0 owns the product and developer-experience backlog that was
previously listed as Version 2.2.0: object member and event authoring,
external metadata authoring and reload, and explicit workbook-to-workbook
transfer.
